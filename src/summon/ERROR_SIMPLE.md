# Simple Error Handling Plan for Summon
...
When the server encounters an unhandled exception, it crashes and clients see
"disconnected". This provides no useful information to users.
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('summon.log'),
...
4. **Actionable Errors**: Users can fix issues (check connection, reduce files,
   fix API key)
...
The philosophy is: "Fail fast, fail clearly, let the user decide what to do
next."
