"""Token estimation and thinking budget utilities for Summon."""
...
MIN_THINKING_TOKENS = 1_024  # Minimum tokens needed for meaningful thinking
FLASH_MAX_THINKING_TOKENS = 32_768  # Google Flash model thinking limit
...
THINKING_LIMITS = {
    ...
    "gemini-2.5-flash-latest": 32_768,
    "gemini-2.5-flash-lite-preview-06-17": 32_768,  # Flash Lite uses same limit as Flash
